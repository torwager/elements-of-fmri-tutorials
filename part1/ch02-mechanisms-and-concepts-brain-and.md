---
title: "2. Mechanisms and Concepts: Brain and Cognitive Neuroscience"
...
:class: tip
- Three distinct advantages a biologically grounded approach offers for understanding the mind: access to latent causes, better categories, and a common scientific language
- What it would mean to "carve the mind at its joints," and why surface-level "folk" categories can mislead us about underlying mechanisms
- How the history of medicine — from Galen's humors to the germ theory — shows what happens when categories are disconnected from generative mechanisms, and what happens when they are reconnected
- Why the current mapping between psychological concepts and brain measures is many-to-many, and how decoding research is beginning to sharpen it
- Why scientific understanding and practical application are intertwined rather than opposed, and why translating brain science into benefits is a "long game" that requires patience and public investment
:::
...
flowchart TD
    ...
    style Y1 fill:#dcfce7,stroke:#22c55e,color:#14532d
    style Y2 fill:#dcfce7,stroke:#22c55e,color:#14532d
...
:::{dropdown} **Q2.** What does it mean to "carve the mind at its joints," and where does the phrase come from?
...
:::{dropdown} **Q3.** Why can categories based on surface features be misleading? Give one of the chapter's examples.
...
:::{dropdown} **Q4.** According to the chapter, is combining neuroscience with behavioral science always better than behavioral science alone?
...
:::{dropdown} **Q5.** What is the current relationship between psychological categories (like fear, attention, and working memory) and patterns of brain activity?
...
:::{dropdown} **Q6.** What was Galen's humoral theory, and what does the chapter use it to illustrate?
...
:::{dropdown} **Q7.** Why were interventions like handwashing and sanitation "inconceivable" before the germ theory?
